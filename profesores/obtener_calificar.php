...
if(isset($_GET['id'])) {
    ...
    $sql ="SELECT DISTINCT m.n_materia, u.id_usuario, u.usuario, u.n_usuario, g.n_grado FROM usuarios u INNER JOIN materias m ON u.id_usuario = m.id_usuario INNER JOIN grados g ON g.id_grado = m.id_grado WHERE g.id_grado = $id AND u.id_rol=1";
