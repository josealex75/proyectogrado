...
<div class="container mt-4">
  ...
  <section id="Grados">
    <h2>Gestión de Grados (Papelera)</h2>
    <div class="row">
      <div class="col-12">
        <a href="index.php" class="btn btn-primary mb-3 ms-3 float-end">
          <i class="bi bi-trash"></i> Grados
        </a>
        ...
        <tbody>
          <?php
               ...
               while($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row["año"] . "</td>";
                echo "<td>";
                echo "<button class='btn btn-success btn-sm' onclick='habilitarGrado (" . $row["id_grado"] . ")'><i class='bi bi-pencil-fill'></i> Habilitar</button>";
                echo "</td>";
                echo "</tr>";
               }
          ?>
